        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card dash-card">
                    <div class="card-body">
                    	<h4 class="text-center mb-5">Pay Bills</h4>
                    	<form action="BillPayHandler" method="POST">
	                    	<div class="row">
	                    		<div class="col-25">
							...
							<div class="row">
	                    		<div class="col-25">
							 	...
							 	<div class="col-50">
							 		<select class="long-text" name="account" required>
								 		<%
							...
							<div class="row">
	                    		<div class="col-25">
							 	...
							 	<div class="col-50">
							 		<select class="long-text"  name="bill" required>
							...
							<div class="row">
	                    		<div class="col-25">
							 		<label><b>Beneficiary Account</b></label> 
							 	</div>
							 	<div class="col-50">
							 		<input class="long-text" type="text" placeholder="Account Number" name="accnumber" required> 
							 	</div>
							</div>
							
							<div class="row">
	                    		<div class="col-25">
							 		<label><b>Customer Reference</b></label> 
							 	</div>
							 	<div class="col-50">
							 		<input class="long-text" type="text" placeholder="customer ref" name="custref" required> 
							 	</div>
							</div>
